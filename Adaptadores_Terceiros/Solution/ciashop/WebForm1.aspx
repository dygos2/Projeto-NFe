<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebForm1.aspx.vb" Inherits="Solution.WebForm1" %>
...
<%
        ...
        Dim xmlload As Xml
          Dim doc As XmlDocument = New XmlDocument()
                                                                                                                    ...
                                                                                                                    'xmldoc = "<?xml version=""1.0"" encoding=""ISO-8859-1"" standalone=""no""?><shopper_resultList xmlns=""https://wssmb.ciashop.com.br/WSIntegSMB/dsReceipt.xsd""><shopper_result xmlns="""" shopper_id=""1"" processed=""1"" /></shopper_resultList>"
                                                                                                                    ...
                                                                                                                    retorno = proxy.Produtos("101810", "integra.2008", xmldoc)
                                                                                                                    MsgBox(xmldoc)
