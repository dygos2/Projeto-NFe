	...
	<xsl:template match="/">
		<NFe>
			<infNFe versao="1.10">
				...
				<!-- Switch de empresa -->
				<!--Matriz-->
				<xsl:if test="NFe/infNFe/emit/CNPJ = '02648146000173' ">
					<emit>
						<CNPJ>02648146000173</CNPJ>
						<xNome>ESSEK COM. IMPORT. EXP. LTDA</xNome>
						<xFant>ESSEK</xFant>
						<enderEmit>
							<xLgr>RUA CONSELHEIRO SARAIVA</xLgr>
							<nro>1036</nro>
							...
							<cPais>1058</cPais>
							<xPais>BRASIL</xPais>
							<fone>1132578155</fone>
						</enderEmit>
						<IE>115320586110</IE>
					</emit>
				</xsl:if>
				<!--Filial-->
				<xsl:if test="NFe/infNFe/emit/CNPJ = '02648146000335' ">
					<emit>
						<CNPJ>02648146000335</CNPJ>
						<xNome>ESSEK COM. IMPORT. EXP. LTDA</xNome>
						<xFant>ESSEK</xFant>
						<enderEmit>
							<xLgr>RUA CHICO PONTES</xLgr>
							<nro>1072</nro>
							<xBairro>VILA GUILHERME</xBairro>
							<cMun>3550308</cMun>
							<xMun>SAO PAULO</xMun>
							<UF>SP</UF>
							<CEP>02067002</CEP>
						...
						<imposto>
							<ICMS>
								...
								<xsl:if test="imposto/ICMS/ICMS51">
									<ICMS51>
										<orig>
											<xsl:value-of select="imposto/ICMS/ICMS51/orig"/>
										</orig>
										<CST>
											<xsl:value-of select="format-number(imposto/ICMS/ICMS51/CST,'00')"/>
										</CST>
										<modBC>
											<xsl:value-of select="imposto/ICMS/ICMS51/modBC"/>
										</modBC>
										<pRedBC>
											<xsl:value-of select="imposto/ICMS/ICMS51/pRedBC"/>
										</pRedBC>
										<vBC>
											<xsl:value-of select="format-number(imposto/ICMS/ICMS51/vBC, '#0.00')"/>
										</vBC>
										<pICMS>
											<xsl:value-of select="imposto/ICMS/ICMS51/pICMS"/>
										</pICMS>
										<vICMS>
											<xsl:value-of select="format-number(imposto/ICMS/ICMS51/vICMS, '#0.00')"/>
										</vICMS>
									</ICMS51>
								</xsl:if>
								...
								<IPI>
									...
									<xsl:if test="imposto/IPI/IPITrib/CST != '' and  imposto/IPI/IPITrib/CST != 0 and (imposto/IPI/IPITrib/CST = 00 or imposto/IPI/IPITrib/CST = 49 or imposto/IPI/IPITrib/CST = 50 or imposto/IPI/IPITrib/CST = 99)">
										<IPITrib>
											...
											<xsl:if test="imposto/IPI/IPITrib/pIPI != '' and number(imposto/IPI/IPITrib/vBC) &gt; 0 ">
												<vBC>
											...
											<xsl:if test="imposto/IPI/IPITrib/qUnid != '' and number(imposto/IPI/IPITrib/vBC) = 0 ">
												<qUnid>
							...
							<PIS>
								...
								<xsl:if test="number(imposto/PIS/PISPadr/CST) != 0 and (imposto/PIS/PISPadr/CST = 04 or imposto/PIS/PISPadr/CST = 06 or imposto/PIS/PISPadr/CST = 07 or imposto/PIS/PISPadr/CST = 08 or imposto/PIS/PISPadr/CST = 09)">
									<PISNT>
										<CST>
											<xsl:value-of select="format-number(imposto/PIS/PISPadr/CST,'00')"/>
										</CST>
							...
							<COFINS>
								...
								<xsl:if test="number(imposto/COFINS/COFINSPadr/CST) != 0 and (number(imposto/COFINS/COFINSPadr/CST) = 04 or number(iimposto/COFINS/COFINSPadr/CST) = 06 or number(imposto/COFINS/COFINSPadr/CST) = 07 or number(imposto/COFINS/COFINSPadr/CST) = 08 or number(imposto/COFINS/COFINSPadr/CST) = 09)">
									<COFINSNT>
										<CST>
											<xsl:value-of select="format-number(imposto/COFINS/COFINSPadr/CST,'00')"/>
										</CST>
