...
<!-- 
								...
								<xsl:if test="imposto/COFINS/COFINSPadr/CST != '' and number(imposto/COFINS/COFINSPadr/CST) != 0 and (number(imposto/COFINS/COFINSPadr/CST) = 04 or number(imposto/COFINS/COFINSNT/CST) = 06 or number(imposto/COFINS/COFINSNT/CST) = 07 or number(imposto/COFINS/COFINSNT/CST) = 08 or number(imposto/COFINS/COFINSNT/CST) = 09)">
									<COFINSNT>
										<CST>
											<xsl:value-of select="format-number(imposto/COFINS/COFINSPadr/CST,'00')"/>
										</CST>
