	...
	<xsl:template match="/">
		<NFe>
          ...
          <tpAmb>
            ...
            <!-- switch de numeros -->
            <!--Matriz-->
            <xsl:if test="NFe/infNFe/emit/CNPJ = '54800768000179' ">
              <nro>48</nro>
            </xsl:if>
            <!--Filial 1-->
            <xsl:if test="NFe/infNFe/emit/CNPJ = '54800768000250' ">
              <nro>45</nro>
            </xsl:if>
            <!--Filial 2-->
	    <xsl:if test="NFe/infNFe/emit/CNPJ = '54800768000330' ">
	      <nro>154</nro>
            </xsl:if>
            <!-- fim do switch de numeros -->
            <xsl:if test="NFe/infNFe/emit/xCpl != '' ">
							<xCpl><xsl:value-of select="NFe/infNFe/emit/enderEmit/xCpl"/></xCpl>
						</xsl:if>
					...
					<det>
						...
						<imposto>
							...
							<xsl:if test="imposto/IPI/cEnq">
								<IPI>
									<xsl:if test="imposto/IPI/clEnq != ''">
										<clEnq>
											<xsl:value-of select="imposto/IPI/clEnq"/>
										</clEnq>
									</xsl:if>
									<xsl:if test="imposto/IPI/CNPJProd != ''">
										<CNPJProd>
											<xsl:value-of select="imposto/IPI/CNPJProd"/>
										</CNPJProd>
									</xsl:if>
									<xsl:if test="imposto/IPI/cSelo != ''">
										<cSelo>
											<xsl:value-of select="imposto/IPI/cSelo"/>
										</cSelo>
									</xsl:if>
									<xsl:if test="imposto/IPI/qSelo != ''">
										<qSelo>
									...
									<xsl:if tdest="imposto/IPI/IPITrib/CST != '' and  imposto/IPI/IPITrib/CST != 0 and (imposto/IPI/IPITrib/CST = 00 or imposto/IPI/IPITrib/CST = 49 or imposto/IPI/IPITrib/CST = 50 or imposto/IPI/IPITrib/CST = 99)">
										<IPITrib>
											<CST>
							...
							<PIS>
								...
								<xsl:if test="imposto/PIS/PISPadr != '' and number(imposto/PIS/PISPadr/CST) != 0 and imposto/PIS/PISPadr/CST = 99 ">
									<PISOutr>
										...
										<xsl:if test="imimposto/PIS/PISPadr/pPIS!= '' and number(imposto/PIS/PISPadr/pPIS) != 0  ">
											<pPIS>
												<xsl:value-of select="translate(format-number(imposto/PIS/PISPadr/pPIS,'#0.00'),',','.')"/>
											</pPIS>
											<vPIS>
							...
							<COFINS>
								...
								<xsl:if test="imposto/COFINS/COFINSPadr/CST != '' and number(imposto/COFINS/COFINSNT/CST) != 0 and (number(imposto/COFINS/COFINSNT/CST) = 04 or number(imposto/COFINS/COFINSNT/CST) = 06 or number(imposto/COFINS/COFINSNT/CST) = 07 or number(imposto/COFINS/COFINSNT/CST) = 08 or number(imposto/COFINS/COFINSNT/CST) = 09)">
									<COFINSNT>
										<CST>
