        ...
        Try
            ...
            For I = 0 To clientes.Count
                ...
                Try
                    ...
                    If (DateDiff(DateInterval.Day, dtHj, dtInc) = 20) Then
                        'envia email "Ultima dia do tria!"

                    ElseIf ((DateDiff(DateInterval.Day, dtHj, dtInc) = 15) Or
                            (DateDiff(DateInterval.Day, dtHj, dtInc) = 10) Or
                            (DateDiff(DateInterval.Day, dtHj, dtInc) = 5)) Then

                        Dim pendencia = Funcs.verificaPendencia(clientes(I))
                        Dim template = Funcs.retornaTemplate(pendencia)
