...
Public Class CartaDeCorrecaoMonitor
    ...
    Private Sub enviarCancelamento(ByVal evento As eventoVO)
        ...
        Dim ws As New NFe3.RecepcaoEvento.RecepcaoEvento
        ...
        Dim cabecalho As New NFe3.RecepcaoEvento.nfeCabecMsg
        ...
        'validando o xsd de envio
        'retornoValidacao = Geral.validarXmlGeral()
