    ...
    <NFe>
      <infNFe versao="3.10">
        ...
        <dest>
          ...
          <indIEDest>
            <xsl:choose>
              <xsl:when test="string(number(NFe/infNFe/dest/IE)) != 'NaN'">1</xsl:when>
              <xsl:when test="NFe/infNFe/dest/IE = 'ISENTO'">2</xsl:when>
              <xsl:otherwise>9</xsl:otherwise>
            </xsl:choose>
          </indIEDest>
          <xsl:if test="NFe/infNFe/dest/IE != '' and NFe/infNFe/dest/IE != '-' and NFe/infNFe/dest/IE != 'ISENTO'">
            <IE>
        ...
        <xsl:for-each select="NFe/infNFe/det">
          <det>
            ...
            <prod>
              ...
              <xsl:for-each select="prod/DI">
                ...
                <xsl:if test="nDI != 0 and nDI != '' ">
                  <DI>
                    ...
                    <tpViaTransp>
                      <xsl:value-of select="tpViaTransp"/>
                    </tpViaTransp>
                    <vAFRMM>
                      <xsl:value-of select="vAFRMM"/>
                    </vAFRMM>
                    <tpIntermedio>
              ...
              <xsl:for-each select="prod/detExport">
                <xsl:if test="nDraw != ''">
                  <detExport>
                    <nDraw>
                      <xsl:value-of select="nDraw" />
                    </nDraw>
                    <xsl:if test="exportInd/nRE != ''">
                      <exportInd>
                        <nRE>
                          <xsl:value-of select="exportInd/nRE" />
                        </nRE>
                        <chNFe>
                          <xsl:value-of select="exportInd/chNFe" />
                        </chNFe>
                        <qExport>
                          <xsl:value-of select="exportInd/qExport" />
                        </qExport>
                      </exportInd>
                    </xsl:if>
                  </detExport>
              ...
              <xsl:if test="prod/nFCI != ''">
                <nFCI>
                  <xsl:value-of select="prod/nFCI" />
                </nFCI>
              </xsl:if>
