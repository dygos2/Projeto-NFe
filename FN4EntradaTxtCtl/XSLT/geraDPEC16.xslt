      ...
      <infNFe versao="2.00">
        ...
        <ide>
          ...
          <xsl:if test="NFe/infNFe/ide/hSaiEnt != '' ">
            <hSaiEnt>
              <xsl:value-of select="NFe/infNFe/ide/hSaiEnt"/>
            </hSaiEnt>
          </xsl:if>
          <tpNF>
...
<xsl:if test="NFe/infNFe/dest/IE = '-' or NFe/infNFe/dest/IE = ''">
          <IE></IE>
</xsl:if>
        ...
        <xsl:for-each select="NFe/infNFe/det">
	      ...
	      <xsl:if test="number(prod/cEANTrib) > 0">	
              ...
              <vUnTrib>
                <xsl:value-of select="translate(format-number(prod/vUnTrib,'#0.0000'),',','.')"/>
              </vUnTrib>
                    ...
                    <xsl:if test="number(imposto/ICMS/ICMS99/CST) = 40 or number(imposto/ICMS/ICMS99/CST) = 41 or number(imposto/ICMS/ICMS99/CST) = 50">
                      <ICMS40>
                        ...
                        <xsl:if test="imposto/ICMS/ICMS99/vICMS != '' and number(imposto/ICMS/ICMS99/vICMS) > 0">
                          ...
                          <xsl:if test="imposto/ICMS/ICMS99/motDesICMS != '' and number(imposto/ICMS/ICMS99/vICMS) > 0">
                          <motDesICMS>
...
<xsl:if test="NFe/infNFe/exporta/UFEmbarq != '' or NFe/infNFe/exporta/xLocEmbarq != ''">
				<exporta>
					<UFEmbarq>
						<xsl:value-of select="NFe/infNFe/exporta/UFEmbarq"/>
					</UFEmbarq>
					<xLocEmbarq>
						<xsl:value-of select="NFe/infNFe/exporta/xLocEmbarq"/>
					</xLocEmbarq>
				</exporta>
  </xsl:if>
