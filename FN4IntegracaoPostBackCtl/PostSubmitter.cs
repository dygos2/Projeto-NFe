...
namespace FN4IntegracaoPostBackCtl
{
    ...
    public class PostSubmitter
    {
        ...
        public PostSubmitter(string url, int timeout)
            : this()
        {
            m_url = url;
        ...
        public PostSubmitter(string url, NameValueCollection values, int timeout)
            : this(url, timeout)
        {
            m_values = values;
        }
        ...
        public string Post()
        {
            ...
            var result = PostData(m_url, parameters.ToString());
            return result;
        }
        /// <summary>
        /// Posts the supplied data to specified url.
