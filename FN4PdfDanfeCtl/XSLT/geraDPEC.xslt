                  ...
                  <ICMS>
                    ...
                    <xsl:if test="imposto/ICMS/ICMS60">
                      <ICMS60>
                        ...
                        <vBCSTRet>
                          <xsl:value-of select="imposto/ICMS/ICMS60/vBCSTRet" />
                        </vBCSTRet>
                        <vICMSSTRet>
                          <xsl:value-of select="imposto/ICMS/ICMS60/vICMSSTRet" />
                        </vICMSSTRet>
                      </ICMS60>
                    </xsl:if> <!-- ICMS60 -->
                    <xsl:if test="imposto/ICMS/ICMS70">
                      <ICMS70>
                        <orig>
