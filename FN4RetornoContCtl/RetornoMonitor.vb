...
Public Class RetornoMonitor
    ...
    Public Sub obterRetornoDasNotas()
        Dim naoEnviadas As List(Of notaVO) = notaDAO_cont.obterRetornosNotas
        Dim nota As notaVO
        ...
        Try
            ...
            For Each nota In naoEnviadas
                ...
                'ws.Url = Geral.Parametro("servicoRetornoRecepcao")
                ...
                xmlprotocolo.Save(nota.pastaDeTrabalho & nota.NFe_ide_nNF & "_protocolo_cont.xml")
                ...
                ElseIf resultado = "656" Then 'consumo indevido
                    ...
                    nota.retEnviNFe_xMotivo = "Rejeição: Consumo Indevido da Sefaz."
                    notaDAO.alterarNota(nota)
