...
'
Namespace NFeRetAutorizacao_PR
    ...
    Partial Public Class NfeRetAutorizacao3
        ...
        Private nfeRetAutorizacaoOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            ...
            Me.Url = Global.FN4RetornoCtl.My.MySettings.Default.FN4RetornoCtl_NFeRetAutorizacao_PR_NfeRetAutorizacao3
        ...
        '''<remarks/>
        Public Event nfeRetAutorizacaoCompleted As nfeRetAutorizacaoCompletedEventHandler
        ...
        '''<remarks/>
        Public Overloads Sub nfeRetAutorizacaoAsync(ByVal nfeDadosMsg As System.Xml.XmlNode)
            Me.nfeRetAutorizacaoAsync(nfeDadosMsg, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub nfeRetAutorizacaoAsync(ByVal nfeDadosMsg As System.Xml.XmlNode, ByVal userState As Object)
            If (Me.nfeRetAutorizacaoOperationCompleted Is Nothing) Then
                Me.nfeRetAutorizacaoOperationCompleted = AddressOf Me.OnnfeRetAutorizacaoOperationCompleted
            End If
            Me.InvokeAsync("nfeRetAutorizacao", New Object() {nfeDadosMsg}, Me.nfeRetAutorizacaoOperationCompleted, userState)
        End Sub
        
        Private Sub OnnfeRetAutorizacaoOperationCompleted(ByVal arg As Object)
            If (Not (Me.nfeRetAutorizacaoCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent nfeRetAutorizacaoCompleted(Me, New nfeRetAutorizacaoCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")>  _
    Public Delegate Sub nfeRetAutorizacaoCompletedEventHandler(ByVal sender As Object, ByVal e As nfeRetAutorizacaoCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class nfeRetAutorizacaoCompletedEventArgs
