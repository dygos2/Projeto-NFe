...
'
Namespace nfecommerce2_homolog
    ...
    Partial Public Class NFeCommerce
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Fn4IntegradorNFeCommerceCtrl.My.MySettings.Default.Fn4IntegradorNFeCommerceCtrl_nfecommerce2_homolog_NFeCommerce
