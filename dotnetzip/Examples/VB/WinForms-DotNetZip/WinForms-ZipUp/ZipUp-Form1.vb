...
Public Class Form1
    ...
    Private Sub DoSave()
        ...
        '        zip1.AddFile("C:\temp\tmp\New Text Document - Copy (2).txt")
        '        zip1.AddFile("C:\temp\tmp\New Text Document - Copy (3).txt")
        '        zip1.AddFile("C:\temp\tmp\New Text Document - Copy (4).txt")
        ...
        Dim zipFileName As String = "C:\temp\MyZipFile.zip"

        Dim fileNames As String() = Directory.GetFiles("C:\temp\tmp\")

        Using zip As Ionic.Zip.ZipFile = New Ionic.Zip.ZipFile
            zip.Encryption = EncryptionAlgorithm.WinZipAes256
            zip.Password = "Albatros$"
